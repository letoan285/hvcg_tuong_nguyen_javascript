...
var Bill = /** @class */ (function () {
    function Bill() {
        this.orangePrice = 45000; // don gia
        this.bananaPrice = 30000;
        this.dragonFruit = 27000;
        this.bill = 0;
    }
    Bill.prototype.getOrangePrice = function (weight) {
        this.bill += this.orangePrice * weight;
        return this;
    };
    Bill.prototype.getBananaPrice = function (weight) {
        this.bill += this.bananaPrice * weight;
        return this;
    };
    Bill.prototype.getDragonFruitPrice = function (weight) {
...
var myBill = new Bill();
var bill = myBill.getOrangePrice(6).getBananaPrice(9).getDragonFruitPrice(4).bill;
